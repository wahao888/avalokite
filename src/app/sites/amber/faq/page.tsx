      ...
      },
      {
        ...
        a: (
          <>
            <ul>
              <li>
                <strong>7-ELEVEN 或全家取貨 60 元</strong>，滿 3,500 元免運
              </li>
              <li>
                <strong>宅配到府 120 元</strong>，滿 5,000 元免運
              </li>
            </ul>
            <p>
              一律先付款。免運門檻看的是<strong>實際出貨的商品金額</strong>——
              有品項缺貨被扣掉、金額掉到門檻以下的話，運費就會照收。
            </p>
          </>
        ),
      },
