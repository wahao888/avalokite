...
> = {
  // 被 2026-09-03 取代的原因：收費時點與違約金的實質改動——
  // ① 月費原本自結帳當月起扣，改為「網站上線並經客戶驗收後」才起算，
  //    下單只收席次保留金並於上線後折抵首期（第二、三條）。
  // ② 承諾期內提前終止的補償，由「補付剩餘月份月費」改為階梯式的
  //    未攤提建置費（第三條、退款政策第二條）。前者第 3 個月走人是 42,000，
  //    大到不會真的請求、也收不到，等於沒有條款。
  // ③ 逾期暫停的效果由「網站維持上線」改為「暫停對外服務」，並寫明
  //    D+3／D+7／D+15／D+30 的催收時程（第九條）。
  //
  // 封存當下的內容雜湊（legalHash，供比對訂單的 agreedTermsHash）：
  //   zh-TW d5f994295701654435356b4cae3d525a
  //   en    b267271715a216775a7302f2ee1a2d89
  "2026-08-31": {
    "zh-TW": {
      "terms": {
        "updated": "2026-08-31",
        "sections": [
          {
            "h": "一、服務提供者與適用範圍",
            "body": [
              "本網站由鏈盾股份有限公司（統一編號 60543664，以品牌「Avalo 阿瓦羅」對外營業，下稱「本公司」）經營，提供網站設計開發、企業 AI 自動化、系統整合等數位服務。",
              "營業地址：臺北市大安區大安路一段191號6樓之1。聯絡電話：0961-187-792。客服信箱：service@avalokite.xyz（與登記信箱 service@chaingull.com 為同一收件匣）。LINE：@avalo。",
          ...
          },
          {
            "h": "十、退款",
            "body": [
              "退款條件、範圍與作業時程，依本站「退款政策」之約定辦理，該政策為本條款之一部分。"
            ]
          },
          {
            "h": "十一、保密",
          ...
          },
          {
            ...
            "body": [
              ...
              "本公司於您下單時記錄您同意之條款版本、時間與內容識別碼，並於訂單確認信中一併載明；您得隨時來信 service@avalokite.xyz 索取當時之條款全文。"
            ]
          },
          {
            "h": "十五、消費者權益之特別說明",
      ...
      "refund": {
        ...
        "sections": [
          ...
          },
          {
            "h": "三、網站健檢服務",
            "body": [
              "健檢報告交付後恕不退款；報告費用可全額折抵 30 日內成立之後續建置服務。"
            ]
          },
          {
            "h": "四、退款方式與時程",
            "body": [
              "退款以原信用卡刷退方式退回，於確認後 14 個工作天內完成。申請請來信 service@avalokite.xyz 並附訂單編號。"
            ]
          },
          {
            "h": "五、爭議處理",
            "body": [
              "對帳款有疑義時，請先來信 service@avalokite.xyz 或以 LINE 與我們聯繫，我們會在一個工作天內回覆。直接向發卡機構提出爭議請款前，請先給我們處理的機會——多數狀況是可以直接解決的。"
            ]
          }
        ]
      }
        ...
        "sections": [
          {
            "h": "1. Provider & Scope",
            "body": [
              "This site is operated by 鏈盾股份有限公司 (Taiwan unified business number 60543664), trading as \"Avalo 阿瓦羅\" (\"the Company\"), providing web development, enterprise AI automation, and systems integration services.",
              "Registered address: 臺北市大安區大安路一段191號6樓之1. Telephone: 0961-187-792. Support: service@avalokite.xyz (same mailbox as our registered email service@chaingull.com). LINE: @avalo.",
          ...
          },
          {
            "h": "10. Refunds",
            "body": [
              "Refund conditions, scope and timing are governed by the Refund Policy on this site, which forms part of these Terms."
            ]
          },
          {
          ...
          },
          {
            ...
            "body": [
              ...
              "We record the version, time and content identifier of the Terms you agreed to, and state them in your order confirmation email. You may request the full text of that version at any time at service@avalokite.xyz."
            ]
          },
          {
      ...
      "refund": {
        ...
        "sections": [
          ...
          },
          {
            "h": "4. Method & Timing",
            "body": [
              "Refunds are issued to the original credit card within 14 business days of confirmation. Email service@avalokite.xyz with your order number to request."
            ]
          },
          {
            "h": "5. Billing Disputes",
            "body": [
              "If something on your statement looks wrong, email service@avalokite.xyz or message us on LINE first — we reply within one business day. Please give us a chance to fix it before filing a chargeback with your card issuer; most cases are resolved directly."
            ]
          }
        ]
      }
  ...
  //
  // 被 2026-08-20 取代的原因：契約主體由品牌名「Avalo 阿瓦羅」改列為法人
  // 「鏈盾股份有限公司」，並載明統編、營業地址與聯絡電話（綠界收款審核要求
  // 銷售網頁揭露與賣家資料一致的營運者資訊，條款本文一併補齊）。
  //
  // 封存當下的內容雜湊（legalHash，供比對訂單的 agreedTermsHash）：
  //   zh-TW 1d8d3d9c9fdd76a8d077bc94243226bd
  //   en    e85d2eae72f4e7124d994f5f6d42bc54
  "2026-08-07": {
    "zh-TW": {
      "terms": {
        "updated": "2026-08-07",
        "sections": [
          {
            "h": "一、服務提供者與適用範圍",
            "body": [
              "本網站由 Avalo 阿瓦羅（下稱「本公司」）經營，提供網站設計開發、企業 AI 自動化、系統整合等數位服務。聯絡方式：service@avalokite.xyz、LINE @avalo。",
              "本條款適用於您透過本網站訂購之所有服務。您於結帳時勾選同意，即與本公司成立契約；本公司會記錄您同意的條款版本與時間，作為雙方權利義務之依據。",
              "本條款中，「建置服務」指網站、AI 應用、自動化流程等一次性交付之專案；「維護方案」指按月計費之託管、備份、監控與內容修改服務。"
            ]
          },
        ...
        "sections": [
          {
            "h": "1. Provider & Scope",
            "body": [
              "This site is operated by Avalo (\"the Company\"), providing web development, enterprise AI automation, and systems integration services. Contact: service@avalokite.xyz, LINE @avalo.",
              "These Terms apply to all services ordered through this site. By checking the agreement box at checkout you enter into a contract with the Company; we record the version of these Terms you agreed to and the time of agreement as the basis of both parties' rights and obligations.",
              "In these Terms, \"Build Services\" means one-time delivered projects (websites, AI applications, automation workflows); \"Care Plan\" means the monthly hosting, backup, monitoring and content-editing service."
            ]
          },
  ...
  // 被 2026-08-31 取代的原因：促銷方案更名——第三條與退款政策原以「首波創始客戶
  // 計畫」為例，該方案已於 2026-08-31 停售並改為「零元啟動・限時開放」，例示因此
  // 改為不綁特定方案名的寫法。條款的實質規範未變。
  //
  // 封存當下的內容雜湊（legalHash，供比對訂單的 agreedTermsHash）：
  //   zh-TW 26f287fef17e7ac2abf557018fce6fda
  //   en    30354853ed155f44de5d8b3f8720499d
  "2026-08-20": {
    "zh-TW": {
      "terms": {
        "updated": "2026-08-20",
