/*
  ...
  - You are about to drop the column `bundles` on the `ShopOrder` table. All the data in the column will be lost.
...
INSERT INTO "new_ShopOrder" ("address", "createdAt", "email", "id", "items", "name", "note", "notified", "payment", "phone", "remitAt", "remitLast5", "remitName", "shippingFee", "status", "subtotal", "tenantId", "total", "updatedAt") SELECT "address", "createdAt", "email", "id", "items", "name", "note", "notified", "payment", "phone", "remitAt", "remitLast5", "remitName", "shippingFee", "status", "subtotal", "tenantId", "total", "updatedAt" FROM "ShopOrder";
