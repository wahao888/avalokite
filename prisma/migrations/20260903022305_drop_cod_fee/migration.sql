/*
  ...
  - You are about to drop the column `codFee` on the `ShopOrder` table. All the data in the column will be lost.
...
INSERT INTO "new_ShopOrder" ("address", "bundles", "createdAt", "email", "id", "items", "name", "note", "notified", "payment", "phone", "remitAt", "remitLast5", "remitName", "shippingFee", "status", "subtotal", "tenantId", "total", "updatedAt") SELECT "address", "bundles", "createdAt", "email", "id", "items", "name", "note", "notified", "payment", "phone", "remitAt", "remitLast5", "remitName", "shippingFee", "status", "subtotal", "tenantId", "total", "updatedAt" FROM "ShopOrder";
