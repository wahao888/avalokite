...
INSERT INTO "new_Subscription" ("authLinkSentAt", "cancelResult", "cancelledAt", "commitEndsAt", "createdAt", "escalatedAt", "gwsr", "id", "lastChargeAt", "merchantTradeNo", "monthlyAmount", "orderId", "previousMtn", "rawReturn", "remindersSent", "sku", "startsAt", "status", "termMonths", "totalSuccessTimes", "updatedAt") SELECT "authLinkSentAt", "cancelResult", "cancelledAt", "commitEndsAt", "createdAt", "escalatedAt", "gwsr", "id", "lastChargeAt", "merchantTradeNo", "monthlyAmount", "orderId", "previousMtn", "rawReturn", "remindersSent", "sku", "startsAt", "status", "termMonths", "totalSuccessTimes", "updatedAt" FROM "Subscription";
